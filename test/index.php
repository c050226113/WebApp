...
class wechatCallbackapiTest
{
    ...
    {
        $echoStr = $this->getArr["echostr"];
        $signature = $this->getArr["signature"];
        $timestamp = $this->getArr["timestamp"];
        $nonce = $this->getArr["nonce"];
        $token = TOKEN;
...
$wechatObj->getArr = $_GET;
$_GET = array();

if (isset($wechatObj->getArr['echostr'])) {
    $wechatObj->valid();
}else{
